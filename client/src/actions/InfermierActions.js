...
export const getInfermier = (id) => (dispatch) => {
  ...
  axios
    .get(`/api/medecin/infermier/${id}`, config)
    .then((res) =>
      dispatch({
        type: GET_INFERMIER,
        payload: res.data,
...
//   };
//   axios
//     .get(`/api/medecin/patient/${id}`, config)
//     .then((res) =>
//       dispatch({
//         type: GET_PATIENT_INF,
//         payload: res.data,
...
export const addInfermier = (newInfermier) => (dispatch) => {
  ...
  axios
    .post("/api/infermier", newInfermier, config)
    .then((res) =>
      dispatch({
        type: ADD_INFERMIER,
        payload: res.data,
...
export const editInfermier = (id, updatedInfermier) => (dispatch) => {
  ...
  axios
    .put(`/api/medecin/medecin/${id}`, updatedInfermier, config)
    .then((res) =>
      dispatch({
